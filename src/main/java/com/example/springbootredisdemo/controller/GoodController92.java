 ...
 *
 * 4. 問題: redissonLock.unlock 可能潛在的問題
 *
 * 5. 後續延伸:
 *      * redisson 原始碼解讀
 *      * redisson 緩存續命如何實現?
...
public class GoodController92 {
    ...
    public String buyGoods() throws Exception {
        ...
        try {
            ...
            /* 在超高併發情況下，若直接呼叫redissonLock.unlock()可能會報錯
               => IllegalMonitorStateException:
                        attempt to unlock lock, not locked by current thread by node id: xxxxx-xxxx- xxx
               解決方式: unlock前先判斷
             */
